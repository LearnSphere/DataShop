 ...
 * <!-- $KeyWordsOff: $ -->
 */
public class MetricByDomainItem extends Item
    ...
    /**
     * Set metricByDomain Id.
     * @param metricByDomainId Database generated unique Id for this report.
     */
    public void setId(Integer metricByDomainId) {
        this.id = metricByDomainId;
    }
    /**
     * Get number of files.
     ...
     */
     public String toString() {
         return super.toString("metricByDomainId", getId(),
                 "files", getFiles(),
                 "papers", getPapers(),
      ...
      */
      public boolean equals(Object obj) {
          ...
          if (obj instanceof MetricByDomainItem) {
              MetricByDomainItem otherItem = (MetricByDomainItem)obj;
