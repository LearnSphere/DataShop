 ...
 * <!-- $KeyWordsOff: $ -->
 */
public class MetricByLearnlabReportItem extends Item
    ...
    /**
     * Get the metricByLearnlab id as a Comparable.
     ...
     */
     public String toString() {
         return super.toString("metricByLearnlabReportId", getId(),
                 "files", getFiles(),
                 "papers", getPapers(),
      ...
      */
      public boolean equals(Object obj) {
          ...
          if (obj instanceof MetricByLearnlabReportItem) {
              MetricByLearnlabReportItem otherItem = (MetricByLearnlabReportItem)obj;
