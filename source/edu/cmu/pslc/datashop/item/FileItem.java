 ...
 * <!-- $KeyWordsOff: $ -->
 */
public class FileItem extends Item implements java.io.Serializable, Comparable   {
    ...
    /** Datasets associated with this file */
    private Set datasets;
    /** Size of the file in bytes */
    private Long fileSize;
    /** IRBs associated with this file */
     ...
     */
    public FileItem(Integer fileId) { this.id = fileId; }
    ...
    /**
     * Set IRBs.
     * @param irbs Collection of IRBs this file is associated with.
     */
    public void setIrbs(Set<IrbItem> irbs) {
        this.irbs = irbs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FileItem) {
            FileItem otherItem = (FileItem)obj;
     ...
     */
    public static Comparator<FileItem> getComparator(SortParameter... sortParameters) {
        return new FileItemComparator(sortParameters);
    }
     ...
     */
    private static final class FileItemComparator implements Comparator<FileItem> {
        /** Sort parameters. */
         ...
         */
        private FileItemComparator(SortParameter[] params) {
