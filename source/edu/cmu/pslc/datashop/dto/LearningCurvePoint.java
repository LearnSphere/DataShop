...
public class LearningCurvePoint extends DTO {
    ...
    private Double secondaryPredictedErrorRate = null;
    ...
    /**
     * Returns secondaryPredictedErrorRate.
     * @return Returns the secondaryPredictedErrorRate.
     */
    public Double getSecondaryPredictedErrorRate() {
        return secondaryPredictedErrorRate;
    }

    /**
     * Set secondaryPredictedErrorRate.
     * @param secondaryPredictedErrorRate The secondaryPredictedErrorRate to set.
     */
    public void setSecondaryPredictedErrorRate(Double secondaryPredictedErrorRate) {
        this.secondaryPredictedErrorRate = formatMe(secondaryPredictedErrorRate);
    }
