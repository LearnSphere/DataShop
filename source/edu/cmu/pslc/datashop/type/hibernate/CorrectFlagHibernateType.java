...
/**
 * UserType to allow Hibernate to uses the CorrectFlag Enumeration type.
 *
 * @author Benjamin Billings
 * @version $Revision: 3682 $
 * <BR>Last modified by: $Author: bkb $
 * <BR>Last modified on: $Date: 2007-01-29 15:42:09 -0500 (Mon, 29 Jan 2007) $
 * <!-- $KeyWordsOff: $ -->
 */
public class CorrectFlagHibernateType implements UserType {
     ...
     */
    public Class returnedClass() { return CorrectFlag.class; }
    ...
    public Object nullSafeGet(ResultSet resultSet, String[] columnNames, Object owner)
        ...
        CorrectFlag toReturn = null;
        if (!resultSet.wasNull()) {
            toReturn = CorrectFlag.getInstance(indexString);
        }
        return toReturn;
    }
