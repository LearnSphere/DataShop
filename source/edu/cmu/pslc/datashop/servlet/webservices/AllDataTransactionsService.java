...
/**
 * Web service for fetching transactions for a dataset's All Data sample.
 * @author jimbokun
 ...
 * <!-- $KeyWordsOff: $ -->
 */
public class AllDataTransactionsService extends TransactionsService {
    /**
     * Constructor.
     ...
     */
    public AllDataTransactionsService(HttpServletRequest req, HttpServletResponse resp,
