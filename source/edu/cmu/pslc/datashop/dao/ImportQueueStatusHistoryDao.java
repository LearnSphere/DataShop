 ...
 * <!-- $KeyWordsOff: $ -->
 */
public interface ImportQueueStatusHistoryDao extends AbstractDao {
     ...
     */
    ImportQueueStatusHistoryItem get(Integer id);
     ...
     */
    ImportQueueStatusHistoryItem find(Integer id);
