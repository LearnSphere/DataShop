...
/**
 * Web service for running a workflow.
 *
 * @author hui cheng
 * @version $Revision: 15840 $
 * <BR>Last modified by: $Author: hcheng $
 * <BR>Last modified on: $Date: 2019-02-01 14:30:47 -0500 (Fri, 01 Feb 2019) $
 * <!-- $KeyWordsOff: $ -->
 */
public class WorkflowRunService extends LearnSphereWebService {
    /** Debug logging. */
     ...
     */
    public WorkflowRunService(HttpServletRequest req, HttpServletResponse resp,
    ...
    public void get(LearnSphereWebServiceUserLog wsUserLog) {
            try {
                    ...
                    learnSphereHelper().runAWorkflow(getAuthenticatedUser(), workflowId, baseDir);
                    //send message on success
                    writeSuccess("Workflow: " + workflowId + " is started to run. Check back for running status.");        
