 ...
 * <!-- $KeyWordsOff: $ -->
 */
public class WorkflowComponentInstanceItem extends Item implements java.io.Serializable, Comparable {
    ...
    public WorkflowComponentInstanceItem() {
        dirtyFile = false;
        dirtyOption = false;
    ...
    public void setState(String state) {
        if (isValidComponentState(state)) {
            this.state = state;
            if (state.equalsIgnoreCase(WorkflowComponentInstanceItem.WF_STATE_NEW)) {
                this.setErrors(null);
    ...
    */
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkflowComponentInstanceItem) {
            WorkflowComponentInstanceItem otherItem = (WorkflowComponentInstanceItem)obj;
